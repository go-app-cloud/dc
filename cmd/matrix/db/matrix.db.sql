...
(
  id        varchar(34) not null comment 'ID'
    primary key,
  app_id    varchar(34) not null comment '程序ID',
  source_id varchar(32) not null comment '数据源ID'
);
...
(
  ...
  description varchar(1024) null comment '详情描述',
  section     varchar(128)  not null comment '数据维护部门',
  owner       varchar(32)   null comment '所属者',
...
INSERT INTO matrix.user (id, username, password, salt, create_at)
VALUES ('b6c837870b0a4fcca737e9459867500e', 'admin', '8e4f00f95901e923569a38207c2c5870',
        'pDT9fFDSVrSet1VbKFacFO5Q4DUWijYp', 0);